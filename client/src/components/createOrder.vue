...
export default {
  ...
  methods: {
    ...
    letsFly() {
      ...
      if (
        (!this.selectedDateArrival && !this.selectedDateDeparture) ||
        (!this.selectedCountryDeparture && !this.selectedCountryArrival) ||
        this.selectedDateArrival < this.selectedDateDeparture ||
        this.selectedDateDeparture.setHours(0, 0, 0, 0) <
